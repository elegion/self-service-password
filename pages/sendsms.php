...
<form action="#" method="post" class="">
    <div class="form-group">
        <label class="control-label"><?php echo $messages["userfullname"]; ?></label>
        <p class="form-control-static"><?php echo $displayname[0]; ?></p>
    </div>
    <div class="form-group">
        <label class="control-label"><?php echo $messages["login"]; ?></label>
        <p class="form-control-static"><?php echo $login; ?></p>
    </div>
    <div class="form-group">
        <label class="control-label"><?php echo $messages["sms"]; ?></label>
...
<form action="#" method="post" class="">
    <div class="form-group">
        <label for="smstoken" class="sr-only control-label"><?php echo $messages["smstoken"]; ?></label>
