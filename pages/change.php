...
<div class="panel-body">
    <h3 class="h3"><?php echo $messages["changetitle"]; ?></h3>
    <?php
    if ( $show_help ) {
...
<form action="#" method="post" class="">
    ...
    <div class="form-group">
        <label for="oldpassword" class="sr-only control-label"><?php echo $messages["oldpassword"]; ?></label>
...
<?php } else {
    ...
    if (isset($messages['passwordchangedextramessage'])) {
        echo "<div class=\"result text-" . get_criticity($result) . "\">";
        echo "<p>" . $messages['passwordchangedextramessage'] . "</p>";
        echo "</div>\n";
    }
